# finrarmag Открытое ERP и CRM программное обеспечение
...
Веб-сайт: [https://www.finrarmagapp.com](https://www.finrarmagapp.com)

## Стек программного обеспечения

finrarmag Бесплатное открытое ERP и CRM приложение, основанное на "mern-stack": Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
