# نرم‌افزار متن‌باز finrarmag ERP & CRM

گیت‌هاب: [https://github.com/finrarmag/finrarmag](https://github.com/finrarmag/finrarmag)
...
finrarmag نرم‌افزار ERP & CRM متن‌باز رایگان است که بر اساس "mern-stack" ساخته شده است: Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
