# finrarmag Phần mềm ERP & CRM mã nguồn mở
...
Trang web: [https://www.finrarmagapp.com](https://www.finrarmagapp.com)

## Cấu trúc phần mềm

finrarmag là ứng dụng ERP & CRM mã nguồn mở miễn phí, dựa trên "mern-stack": Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
